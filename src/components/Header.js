...
export default function Header() {
  ...
  return (
    <header className="bg-white shadow-md fixed top-0 left-0 w-full z-50">
      <div className="container px-4 py-3 flex justify-between items-center max-w-6xl mx-auto p-4">
        {/* Logo */}
        ...
        <nav className="hidden md:flex space-x-6">
          ...
          <Link href="/product" className="hover:text-blue-500">Sản phẩm</Link>
      ...
      {menuOpen && (
        <nav className="md:hidden bg-white shadow-md p-4 absolute top-full left-0 w-full">
          ...
          <Link href="/product" className="block py-2">Sản phẩm</Link>
